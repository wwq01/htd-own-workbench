...
export const ErrorCodes = {
  ...
  // 本地 Agent 通道相关错误（V2-1）
  AGENT_TASK_NOT_FOUND: 'PARAM.AGENT.TASK_NOT_FOUND',
  AGENT_SKILL_NOT_FOUND: 'PARAM.AGENT.SKILL_NOT_FOUND',
  AGENT_PROMPT_REQUIRED: 'PARAM.AGENT.PROMPT_REQUIRED',
  AGENT_RUN_FAILED: 'EXEC.AGENT.RUN_FAILED',
  // 取消「已开始执行」的任务：同步技能无法安全中断，明确报错而非静默
  AGENT_TASK_CANCEL_NOT_ALLOWED: 'EXEC.AGENT.CANCEL_NOT_ALLOWED',
};
...
export const ErrorMessages = {
  ...
  [ErrorCodes.AGENT_TASK_CANCEL_NOT_ALLOWED]: '任务正在执行，无法取消（同步技能无法安全中断）',
};
